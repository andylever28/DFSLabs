class Player < ApplicationRecord
	...
	def self.api_call
		...
		response["players"].each do |player|
			...
			play.rank_stat.update(pga_rank: stat["world_rank"].to_i, avg_score_last_year: stat["scoring_avg"].to_f.round(2), top_ten: stat["top_10"].to_i, vegas_odds: 0, missed_cut: missed_cut) 
